...
class TakeawayScene(Scene):
    def construct(self):
        ...
        self.play(
            pipeline.animate.set_opacity(DIM_OPACITY),
            stat_bugs.animate.set_opacity(DIM_OPACITY),
            stat_cves.animate.set_opacity(DIM_OPACITY),
            stat_faster.animate.set_opacity(DIM_OPACITY),
            stat_exploits.animate.set_opacity(DIM_OPACITY),
        )
