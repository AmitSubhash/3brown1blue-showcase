...
class GoldenModelScene(Scene):
    def construct(self):
        ...
        example_tags.next_to(grm_box, RIGHT, buff=0.4)
        # Guard: keep within safe horizontal bounds
        if example_tags.get_right()[0] > 5.5:
            example_tags.shift(LEFT * (example_tags.get_right()[0] - 5.5))
        ...
        examples_header.next_to(example_tags, UP, buff=0.2)
